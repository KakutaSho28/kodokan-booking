    ...
    >
      ...
      >
        ...
        <div class="mt-6 flex justify-end gap-3">
          <button
            class="min-h-10 rounded-md bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-400"
            type="button"
            @click="cancel"
          >
            キャンセル
          ...
          <button
            class="min-h-10 rounded-md px-4 py-2 text-sm font-semibold text-white transition focus:outline-none focus:ring-2"
